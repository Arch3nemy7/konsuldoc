...
class _CreateAppointmentState extends State<CreateAppointment> {
  ...
  decoration: InputDecoration(
    labelText: 'Masukkan keluhan sakit', // Judul yang ditampilkan di atas border
    ...
    labelStyle: TextStyle(
      color: Colors.black, // Warna label menjadi hitam
      fontSize: 22, // Ukuran label
      fontWeight: FontWeight.w500, // Untuk menambahkan ketebalan teks
    ),
    floatingLabelBehavior: FloatingLabelBehavior.always, // Label selalu mengambang
  ),
  maxLines: null, // Untuk membuat TextField dapat menampilkan beberapa baris
  keyboardType: TextInputType.multiline, // Untuk memudahkan penggunaan teks panjang
)
,
              SizedBox(height: 20),
              Center(
